...
if ( ! class_exists( 'BuilderExtensionMagazineLayout' ) ) {
	class BuilderExtensionMagazineLayout {
		...
		function BuilderExtensionMagazineLayout() {
							...
							<div <?php post_class('magazine-post-wrap'); ?>>
								<div class='magazine-post entry-content'>
									<div class="entry-header">
										...
										<?php else : ?>
											<?php edit_post_link( '<img width="350" height="150" src="' . $this->_base_url . '/images/no-feature-image.jpg" class="it-magazine-thumb no-thumb" />', '<div class="entry-meta post-image">', '</div>' ) ; ?>
										<?php endif; ?>
										
										<h2 class="entry-title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>
										<div class="entry-meta">
											<?php printf( __( '%s', 'it-l10n-Builder-Acute-Blue' ), '<span class="the_date">' . get_the_date() . '</span>' ); ?>
											<?php do_action( 'builder_comments_popup_link', '<span class="comments"> | ', '</span>', __( '%s Comments', 'it-l10n-Builder-Acute-Blue' ), __( '0', 'it-l10n-Builder-Acute-Blue' ), __( '1', 'it-l10n-Builder-Acute-Blue' ), __( '%', 'it-l10n-Builder-Acute-Blue' ) ); ?>											
										</div>
									</div>
